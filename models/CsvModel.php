...
class CsvModel extends Model
{
    ...
    {
        return [
            "modelClass"=>\Yii::t('common', 'Model class'),
            "filePath"=>\Yii::t('common', 'File path'),
            "headLine"=>\Yii::t('common', 'Head line'),
            "key"=>\Yii::t('common', 'Key'),
            "delimiter"=>\Yii::t('common', 'Delimiter'),
            "enclosure"=>\Yii::t('common', 'Enclosure'),
            "escape"=>\Yii::t('common', 'Escape'),
            "mapping"=>\Yii::t('common', 'Attributes to columns mapping'),
            "validate"=>\Yii::t('common', 'Validate model'),
