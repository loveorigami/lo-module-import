...
namespace lo\modules\import\modules\admin\controllers;

use lo\modules\import\models\CsvModel;
use Yii;
...
class CsvImportController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if(Yii::$app->request->isPost) {
            ...
            if($load AND $model->validate()) {
                ...
                return $this->redirect(['csv-import/import']);
            }
    ...
    public function actionImport()
    {
        ...
        if(!$model)
            return $this->redirect(['csv-import/index']);
